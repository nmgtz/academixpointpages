 const NMG_SCRIPT_ = 'https://script.google.com/macros/s/AKfycbxaMpVdGPtkJB94ADOer_FFNrVMIEuxLh4P-knZhBSx5YysMKg2tESUaPR5nhhExWsW/exec';
    ...
    async function fetchSchoolDataFromServer() {
        ...
        try {
            ...
            console.error('Full loaded error:', error);
            return null;
        }
    }
    ...
    if (currentSchoolData && currentSchoolData.urls) { 
        ...
        log('🔄 RepResURLs updated with server data');
        ...
        if (typeof RepResURLs !== 'undefined') {
            log('✅ Using existing RepResURLs from page');
        } else {
...
function switchLanguage(lang) {
  ...
  function updateReport(index) {
    ...
    const translatedClass = lang.classLevels[examClass.toUpperCase()] || examClass;
      ...
      <div style="position: relative; min-height: 100vh; overflow: hidden;">
        ...
        <div style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; 
          ...
          <div style="position: absolute; top: 50%; left: 50%; 
                      ...
                      color: rgba(0,0,0,0.05); white-space: nowrap;
        ...
        <div style="position: relative; z-index: 2; background: transparent;">
          ...
          <h2 style="text-align: center; margin: 40px 0 0 0;">${lang.governmentHeader}</h2>
          ...
          <h4 style="text-align: center; margin: 10px 0;">${reportTitleFormatted}</h4><br>
          ...
          <div style="display: flex; gap: 20px; margin-top: 5px; flex-wrap: wrap;">
            ...
            <div style="flex: 1; width: 300px;">
              ...
              <table class="behavior-table" style="width: 100%; border-collapse: collapse; margin-top: -20px;">
                <thead>
                  <tr><th style="border: 1px solid #ccc;">${lang.aspect}</th><th style="border: 1px solid #ccc;">${lang.rating}</th></tr>
                </thead>
                <tbody>
                  ${Object.entries({
                  ...
                  <tr><td colspan="2" style="border: 1px solid #ccc;"><strong>${lang.remarks}</strong> ${remark}</td></tr>
                </tbody>
              </table>
            </div>
          </div>
