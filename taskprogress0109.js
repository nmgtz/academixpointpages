    ...
    reportDiv.innerHTML = `
      <div style="position: relative; min-height: 100vh; overflow: hidden; background: #ffffff;">
        ...
        <div style="position: relative; z-index: 2; background: transparent;">
          ...
          <h4 style="text-align: center; margin: 10px 0; color: #0d47a1; padding: 8px 0; border-top: 2px solid #64b5f6; border-bottom: 2px solid #64b5f6;">${reportTitleFormatted}</h4><br>
          ...
          <div style="display: flex; gap: 20px; margin-top: 5px; flex-wrap: wrap;">
            <div style="flex: 2; width: 600px;">
              <h4 style="color: #0d47a1; padding: 8px 0; margin-bottom: 8px;">${lang.performanceTitle}</h4>
            ...
            <div style="flex: 1; width: 300px;">
              <h4 style="color: #0d47a1; padding: 8px 0; margin-bottom: 8px;">${lang.behavior}</h4>
          ...
          <div style="margin-top: 10px; font-size: 14px; line-height: 1.6; color: #424242;">
            ...
            <p style="padding: 8px 0;"><strong style="color: #1565c0;">${lang.requirements}:</strong></p>
