...
'html{height:100%}'+
'body{min-height:100%;background:#f0f2f7;font-family:\'Segoe UI\',system-ui,sans-serif;font-size:14px;color:#1e2a4a;display:flex;flex-direction:column}'+
...
/* LAYOUT */
'#axpLayout{display:flex;min-height:100vh;flex-direction:column}'+
/* HEADER */
...
/* BODY ROW */
'#axpBody{display:flex;flex:1;overflow:hidden}'+
/* SIDEBAR */
'#axpSidebar{width:210px;background:var(--pri3);flex-shrink:0;display:flex;flex-direction:column;overflow-y:auto}'+
'.sb-school{padding:16px 14px 12px;border-bottom:1px solid rgba(255,255,255,.1)}'+
'.sb-school-name{font-size:11.5px;font-weight:700;color:#fff;line-height:1.3;margin-bottom:3px}'+
'.sb-school-code{font-size:10px;color:rgba(255,255,255,.4);letter-spacing:.5px}'+
...
'.sb-year{margin-top:auto;padding:12px 14px;border-top:1px solid rgba(255,255,255,.08);font-size:10.5px;color:rgba(255,255,255,.3)}'+
'.sb-year strong{color:rgba(255,255,255,.55)}'+
/* SIDEBAR OVERLAY */
'#axpSbOverlay{display:none;position:fixed;inset:0;background:rgba(0,0,0,.45);z-index:250}'+
/* CONTENT */
'#axpContent{flex:1;min-width:0;overflow-y:auto;padding:22px 22px 80px}'+
/* PAGE TITLE */
...
'#axpMenuBtn{display:block}'+
'#axpSidebar{position:fixed;top:54px;left:0;bottom:0;z-index:260;transform:translateX(-100%);transition:transform .2s ease}'+
...
'<div id="axpHdr">'+
  ...
  '<div class="hdr-brand"><div class="hdr-name">ACADEMIXPOINT</div><div class="hdr-tag">School Management</div></div>'+
  '<div class="hdr-div"></div>'+
  '<div class="hdr-info"><div class="hdr-sname" id="axpHdrName">Loading…</div><div class="hdr-smeta" id="axpHdrMeta"></div></div>'+
  '<div class="hdr-badge" id="axpHdrBadge">ACTIVE</div>'+
'</div>'+
...
/* SIDEBAR */
'<div id="axpSidebar">'+
  '<div class="sb-school"><div class="sb-school-name" id="axpSbName">—</div><div class="sb-school-code" id="axpSbCode">—</div></div>'+
  '<div class="sb-section">Marks Entry</div>'+
  '<div class="sb-item active"><i class="bi bi-pencil-square"></i><span>Enter Marks</span></div>'+
  '<div class="sb-item"><i class="bi bi-people"></i><span>Students</span></div>'+
  '<div class="sb-item"><i class="bi bi-journal-bookmark"></i><span>Exams</span></div>'+
  '<div class="sb-section">Reports</div>'+
  '<div class="sb-item"><i class="bi bi-file-earmark-bar-graph"></i><span>Results</span></div>'+
  '<div class="sb-item"><i class="bi bi-download"></i><span>Export</span></div>'+
...
'<div id="axpContent">'+
  ...
  '<div class="pg-title">Marks Entry</div>'+
  '<div class="pg-sub">Select class, exam type and subject to begin entering marks.</div>'+
...
'<div id="axpToast"></div>';
  ...
  async function axpInit(){
    try{
      ...
      /* Sidebar */
      var sbName=g('axpSbName'); if(sbName)sbName.textContent=S.schoolName;
      var sbCode=g('axpSbCode'); if(sbCode)sbCode.textContent='S'+S.digits;
