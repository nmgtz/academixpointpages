...
<h4 style="text-align: center; margin: 10px 0;">Report of Examination Results 2025</h4><br>

<p style="margin: 2px 0;">
  This report serves to notify that <strong>${student.name}</strong><br> sat for Terminal Examination held in <strong>May 2025</strong> at <strong>Academix Point Secondary school.</strong><br>This reflects their academic standing and progress during the evaluation period.
</p>
...
`; 
const closingDate = formData.closingDate;
const classTeacher = formData.classTeacher;
const headmaster = formData.headmaster;
