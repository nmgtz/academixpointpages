...
function buildSubjectTable(students) {
  ...
  for (let i = 0; i < totalColumns; i++) {
    ...
    if (i === 0) col.style.width = '15%'; // SUBJECT
    else if (i >= 1 && i <= 3) col.style.width = '5%'; // SAT-F, SAT-M, TOTAL
    else if (i >= 4 && i <= 15) col.style.width = '3.5%'; // A(F) to F(M)
    else if (i === 16 || i === 17) col.style.width = '5%'; // AVER, GPA
    else if (i === 18) {
      col.style.width = '25%';
      col.style.textAlign = 'left'; // GRADE
    }
