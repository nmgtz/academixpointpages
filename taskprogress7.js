...
<p style="margin: 2px 0;">
 This report serves to notify that <strong>${student.name}</strong><br> sat for ${examType.toUpperCase()} EXAMINATION in <strong>${month.toUpperCase()}</strong> at <strong>${schoolName.toUpperCase()}.</strong><br>This reflects their academic standing and progress during the evaluation period.
</p>
