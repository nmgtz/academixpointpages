...
function buildStudentTable(students) {
  ...
  allRows.forEach(row => {
    ...
    if (cells.length > 0) {
      ...
      cells[0].style.padding = '1px 4px';
      
      cells[1].style.width = '16%';    
      cells[1].style.textAlign = 'left';
      cells[1].style.padding = '1px 4px';
