...
<h4 style="text-align: center; margin: 10px 0;">${schoolName} - ${schoolIndex}</h4><br>
<h4 style="text-align: center; margin: 10px 0;">Report of Examination Results,${month}</h4><br>

<p style="margin: 2px 0;">
 This report serves to notify that <strong>${student.name}</strong><br> sat for Terminal Examination held in <strong>${month}</strong> at <strong>Academix Point Secondary school.</strong><br>This reflects their academic standing and progress during the evaluation period.
</p>
