...
function hideLoadingOverlay() {
  ...
  if (overlay) overlay.style.display = 'none';
    ...
    window.showSubjectDiv = showSubjectDiv;
    window.showDataSent = showDataSent;
    window.submitTableData = submitTableData;
    window.getDataAndBuildUI = getDataAndBuildUI;
    window.showStudentsDiv = showStudentsDiv;
    window.submitSubjects = submitSubjects();
 })();
