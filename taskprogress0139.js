...
downloadAllBtn.addEventListener("click", async () => {
  ...
  try {
    for (let i = 0; i < eligible.length; i++) {
      ...
      downloadAllBtn.textContent = `Downloading ${i + 1}/${eligible.length} - Click to Stop`;
    ...
    if (isDownloadingAll) {
      alert(`Successfully downloaded ${eligible.length} reports!`);
    } else {
      alert(`Download stopped. Downloaded ${currentIndex} reports.`);
    }
