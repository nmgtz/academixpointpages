...
function buildSubjectTable(students) {
  ...
  const overallStats = {
    ...
    clean: { F: 0, M: 0 },
    absent: { F: 0, M: 0 },
    INC: { F: 0, M: 0 }  // Changed to uppercase 'INC'
  };
  ...
  // Calculate INC using the shortcut: Clean - (sum of all divisions)
  ...
  // Sub-header row (F, M, T) - FIXED: Removed the hidden spacer cell
  ...
  // General stats columns - Changed key to 'INC'
