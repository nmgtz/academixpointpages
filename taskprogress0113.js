...
function buildSubjectTable(students) {
  ...
  subjects.forEach(subject => {
    ...
    // Apply background color based on grade
    if (gradeText.startsWith('A')) {
      tdComment.style.backgroundColor = '#90EE90';
      tdComment.style.fontWeight = 'bold';
    } else if (gradeText.startsWith('B')) {
      tdComment.style.backgroundColor = '#ADD8E6';
      tdComment.style.fontWeight = 'bold';
    } else if (gradeText.startsWith('C')) {
      tdComment.style.backgroundColor = '#FFFFE0';
      tdComment.style.fontWeight = 'bold';
    } else if (gradeText.startsWith('D')) {
      tdComment.style.backgroundColor = '#FFD700';
      tdComment.style.fontWeight = 'bold';
    } else if (gradeText.startsWith('F')) {
      tdComment.style.backgroundColor = '#FFB6C6';
      tdComment.style.fontWeight = 'bold';
    }
