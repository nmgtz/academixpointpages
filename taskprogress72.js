...
async function createExcelFile(students, examType = '', selectedClass = '') {
  try {
    ...
    // Extract all unique subjects from student scores
    ...
    // Create header row - Simple format: S/N, Student Name, Gender, Subject1, Subject2, etc.
