...
function buildSubjectTable(students) {
  ...
  // First column
  gradeRow.appendChild(Object.assign(document.createElement('th'), { textContent: 'SUBJECT', rowSpan: 2 }));
  ...
  if (!document.getElementById('subject-table-style')) {
    ...
    style.textContent = `
      ...
      /* SUBJECT column */
      table.subject-table th:first-child,
      table.subject-table td:first-child {
        width: 15%;
        font-weight: bold;
        text-align: left;
      }
      ...
      /* Grade columns (A-F for both sexes) - 10 columns */
      table.subject-table th:nth-child(n+5):nth-child(-n+14),
      table.subject-table td:nth-child(n+5):nth-child(-n+14) {
        width: 3.5%;
      }

      /* AVER, GPA, GRADE columns */
      ...
      /* Final column (GRADE COMMENT) - make this wider */
      table.subject-table th:nth-child(17),
      table.subject-table td:nth-child(17) {
        width: 20%;
        text-align: left;
